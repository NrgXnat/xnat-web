...
@Component
public class Entity2UpdateHandlerMethod extends AbstractTrackingHibernateEntityEventHandlerMethod {
    public Entity2UpdateHandlerMethod() {
        super(Action.UPDATE, Entity2.class);
    }
    ...
    public Future<Boolean> handleEvent(final AbstractEvent event) {
        ...
        getTestEventTracker().addEvent(Action.UPDATE, Entity2.class, entity.getId());

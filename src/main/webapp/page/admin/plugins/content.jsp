                                                                             ...
                                                                             "\"accessSettingInfo\": {" +
                                                                               ...
                                                                               "\"contents\": {" +
                                                                                 "\"info\": {" +
                                                                                   ...
                                                                                   "}," +
                                                                                   "\"contents\": \"Access is restricted to role(s):  <b>"  + restrictedTabConfig['meta']['restricted'] + "</b> <br><br> Please contact the Site Admin to grant this role to your user profile to administer this feature.\""+
                                                                                 "}" +
                                                                               "}" +
                                                                             "}" +
                                                                           "}" +

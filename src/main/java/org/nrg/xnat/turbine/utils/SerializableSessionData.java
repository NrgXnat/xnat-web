...
public class SerializableSessionData implements ApplicationTool, Serializable {
    ...
    private static final Logger logger = Logger.getLogger(SerializableSessionData.class);
    ...
    public SerializableSessionData() {
        logger.debug("SerializableSessionData initialized");
    }
    ...
    public void init(Object data) {
        logger.debug("SerializableSessionData init() called");
    ...
    @Override
    public void refresh() {
        logger.debug("SerializableSessionData refresh() called");
    ...
    public Object put(String key, Object value) {
        ...
        if (value != null && !(value instanceof Serializable)) {
            logger.warn("Non-serializable value of type " + value.getClass().getName() +
                       " stored for key '" + key + "'. This may cause Redis session persistence to fail.");
        }
     ...
     */
    public void clear() {
        logger.debug("Clearing all session data (" + data.size() + " entries)");
        data.clear();
    }

...
@XnatSerializer
@Slf4j
public class XnatOpsessiondataSerializer<T extends XnatOpsessiondata> extends XnatImagesessiondataSerializer<T> {
    private static final long serialVersionUID = 3070752178407788507L;

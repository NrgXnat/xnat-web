...
@Component
@Slf4j
public class XnatGmvscandataSerializer<T extends XnatGmvscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = -43598094841888021L;

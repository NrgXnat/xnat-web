...
@Component
@Slf4j
public class XnatMgsessiondataSerializer<T extends XnatMgsessiondata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 489088999876994338L;

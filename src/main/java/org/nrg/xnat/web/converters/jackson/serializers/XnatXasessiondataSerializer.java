...
@Component
@Slf4j
public class XnatXasessiondataSerializer<T extends XnatXasessiondata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = -7708214999902493697L;

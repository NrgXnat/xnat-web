...
@Component
@Slf4j
public class XnatDxscandataSerializer<T extends XnatDxscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = -142952818053549219L;

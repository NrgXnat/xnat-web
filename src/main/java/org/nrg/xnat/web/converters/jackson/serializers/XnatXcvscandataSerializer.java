...
@Component
@Slf4j
public class XnatXcvscandataSerializer<T extends XnatXcvscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 8593303099977971172L;

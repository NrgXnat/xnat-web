...
@Component
@Slf4j
public class XnatEcgscandataSerializer<T extends XnatEcgscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = -2490727264439638999L;

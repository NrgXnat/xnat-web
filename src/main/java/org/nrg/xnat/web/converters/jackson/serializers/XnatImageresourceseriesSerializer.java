...
@XnatSerializer
@Slf4j
public class XnatImageresourceseriesSerializer<T extends XnatImageresourceseries> extends XnatResourceseriesSerializer<T> {
    private static final long serialVersionUID = -5748599231289379826L;

...
@Component
@Slf4j
public class XnatXcsessiondataSerializer<T extends XnatXcsessiondata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = -2421389329618351026L;

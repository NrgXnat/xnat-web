...
@Component
@Slf4j
public class XnatVoiceaudioscandataSerializer<T extends XnatVoiceaudioscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = -1087142270919357302L;

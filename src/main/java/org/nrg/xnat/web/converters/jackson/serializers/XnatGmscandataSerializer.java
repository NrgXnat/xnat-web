...
@Component
@Slf4j
public class XnatGmscandataSerializer<T extends XnatGmscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 4549732168986492472L;

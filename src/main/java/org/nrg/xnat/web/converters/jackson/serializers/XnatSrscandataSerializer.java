...
@Component
@Slf4j
public class XnatSrscandataSerializer<T extends XnatSrscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 8798875646019895371L;

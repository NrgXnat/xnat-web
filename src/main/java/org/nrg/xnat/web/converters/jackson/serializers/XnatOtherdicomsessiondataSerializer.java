...
@Component
@Slf4j
public class XnatOtherdicomsessiondataSerializer<T extends XnatOtherdicomsessiondata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 5007502995282575003L;

...
public class ArcArchivespecificationNotificationTypeSerializer<T extends ArcArchivespecificationNotificationType> extends AbstractBaseElementSerializer<T> {
    ...
    protected void serializeImpl(final T instance, final JsonGenerator generator, final SerializerProvider provider) throws IOException {
        ...
        writeNonNullNumber(generator, "arcArchivespecificationNotificationTypeId", instance.getArcArchivespecificationNotificationTypeId());
        writeNonBlankField(generator, "emailAddresses", instance.getEmailAddresses());
        writeNonBlankField(generator, "notificationType", instance.getNotificationType());
    }
}

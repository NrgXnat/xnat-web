...
@Component
@Slf4j
public class XnatMrsscandataSerializer<T extends XnatMrsscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 7165355030037255149L;

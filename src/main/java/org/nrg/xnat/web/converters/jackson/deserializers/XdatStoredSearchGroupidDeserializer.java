...
public class XdatStoredSearchGroupidDeserializer<T extends XdatStoredSearchGroupid> extends AbstractBaseElementDeserializer<T> {
    private static final long serialVersionUID = 5222185298767421650L;
    ...
    public XdatStoredSearchGroupidDeserializer(final Class<T> clazz) {
        super(clazz);
    }
    ...
    protected void handleField(final T instance, final String field, final JsonParser parser, final DeserializationContext context) throws IOException {
        ...
        switch (field) {
            ...
            case "xdatStoredSearchGroupidId":
                // TODO: Handle the "xdatStoredSearchGroupidId" property here: Integer
                break;
            default:

...
@Component
@Slf4j
public class XnatCrscandataSerializer<T extends XnatCrscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 4976516867643688853L;

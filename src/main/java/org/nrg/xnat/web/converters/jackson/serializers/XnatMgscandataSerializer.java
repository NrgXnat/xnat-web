...
@Component
@Slf4j
public class XnatMgscandataSerializer<T extends XnatMgscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 4868023374387004981L;

...
public class XnatPetscandataDeserializer extends AbstractBaseElementDeserializer<XnatPetscandata> {
    public XnatPetscandataDeserializer() {
        super(XnatPetscandata.class);
    }
    
    @Override
    protected XnatPetscandata deserializeImpl(final JsonParser parser, final DeserializationContext context) throws IOException {
        final XnatPetscandata scans = new XnatPetscandata();
	...
	@Override
	protected XnatPetscandata getNewInstance() throws JsonProcessingException {

...
@Component
@Slf4j
public class XnatOpscandataSerializer<T extends XnatOpscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = -765021048484204453L;

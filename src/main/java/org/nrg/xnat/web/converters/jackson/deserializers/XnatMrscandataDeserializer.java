...
public class XnatMrscandataDeserializer extends AbstractBaseElementDeserializer<XnatMrscandata> {
    public XnatMrscandataDeserializer() {
        super(XnatMrscandata.class);
    }
    
    @Override
    protected XnatMrscandata deserializeImpl(final JsonParser parser, final DeserializationContext context) throws IOException {
        final XnatMrscandata scans = new XnatMrscandata();

...
@Component
@Slf4j
public class XnatSmsessiondataSerializer<T extends XnatSmsessiondata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 5824104309030008637L;

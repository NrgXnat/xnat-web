...
@XnatSerializer
@Slf4j
public class XnatEcgsessiondataSerializer<T extends XnatEcgsessiondata> extends XnatImagesessiondataSerializer<T> {
    private static final long serialVersionUID = 2031564520571400580L;

...
@Component
@Slf4j
public class XnatNmscandataSerializer<T extends XnatNmscandata> extends AbstractBaseElementSerializer<T> {
    private static final long serialVersionUID = 2485113198333695325L;

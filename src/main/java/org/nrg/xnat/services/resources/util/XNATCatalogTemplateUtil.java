...
public class XNATCatalogTemplateUtil extends XNATTemplateUtil{
    ...
    public void  setResourceXNATCatalogTemplateUtil(final boolean allowAll) throws ClientException {
...
//    }
    ...
    public static class ResourceMap {
    	public static final Function<ResourceMap, String> FUNCTION_RESOURCE_MAP = new Function<ResourceMap, String>() {
            @Override
    ...
    @Data
    @Accessors(prefix = "_")
    public static class PermittedResourcePredicate implements Predicate<ResourceMap> {
    ...
    private final NamedParameterJdbcTemplate _template = null;
    public static final String QUERY_FIND_RESOURCE_SECURE_OBJECTS = "SELECT " +
    ...
    public static final RowMapper<ResourceMap>               RESOURCE_MAP_ROW_MAPPER = new RowMapper<ResourceMap>() {
        @Override
    ...
    public static final Function<XnatExperimentdata, String> FUNCTION_EXPERIMENT_IDS = new Function<XnatExperimentdata, String>() {
        @Override

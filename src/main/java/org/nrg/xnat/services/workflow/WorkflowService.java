...
public interface WorkflowService {
	...
	void updateWorkflow(UserI user, String workflowId, WrkWorkflowdata workflowData) throws NotFoundException, InsufficientPrivilegesException, DataFormatException, ElementNotFoundException, FieldNotFoundException; 
}

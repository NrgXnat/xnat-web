...
public interface AssessorService {
	 ...
	 Optional<List<XnatImageassessordata>> findAllByProjectIdAndSubjectIdAndExperimentId(UserI user, String projectId, String subjectId, String experimentId) throws DataFormatException, NotFoundException;
	 ...
	 Optional<List<XnatImageassessordata>> findAllByExperimentId(UserI user, String experimentId) throws DataFormatException, NotFoundException;

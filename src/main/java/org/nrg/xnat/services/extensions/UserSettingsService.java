...
public interface UserSettingsService {
	...
	XdatUserUtil findUserByUserId(UserI user, String userId) throws InitializationException, InsufficientPrivilegesException, UserNotFoundException, UserInitException;

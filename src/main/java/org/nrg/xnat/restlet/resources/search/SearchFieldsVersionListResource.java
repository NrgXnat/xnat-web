				...
				if (filepath.startsWith("modify")) {
					...
					if (RequestUtil.compareMediaType(entity, MediaType.APPLICATION_JSON)) {
						try {
							...
							org.nrg.xdat.display.transport.entities.DisplayVersion dv = mapper.readValue(entity.getStream(), org.nrg.xdat.display.transport.entities.DisplayVersion.class);
	...
	public Representation getRepresentation(Variant variant) {	        
		try {
			...
			if(this.isQueryVariableTrue("listViews")){
				...
				org.nrg.xdat.display.transport.entities.DisplayVersion storedDV = getElementDisplayService().convertDisplayVersion(dv);

package org.nrg.xapi.rest.search;
...
// TODO: The eventReason, eventId, eventType, eventAction, and eventComment parameters aren't used in deleteSavedSearchByProjectIdAndSearchId().
...
public class SearchApi extends AbstractXapiProjectRestController {
    ...
    public XdatStoredSearchI getSavedSearchBySearchId(@ApiParam(value = "The ID of the search saved.") @PathVariable final String searchId,
                                                      @ApiParam(value = "The dv search value.") @RequestParam(required = false) final String dv,
                                                      @ApiParam(value = "The project search value.") @RequestParam(required = false) final String project) throws NotFoundException, InsufficientPrivilegesException {
    ...
    @ApiOperation(value = "Gets the requested search element", notes = "Returns the stored search elements", response = SearchElement.class, responseContainer = "list")
    ...
    @ApiOperation(value = "Gets the requested search elements", notes = "Returns the requested search elements", response = XnatSearchElement.class, responseContainer = "list")
    @ApiResponses({@ApiResponse(code = 200, message = "Returns the requested search elements."),
                   @ApiResponse(code = 404, message = "The requested search elements wasn't found."),
                   @ApiResponse(code = 500, message = "An unexpected or unknown error occurred.")})
    ...
    @ApiOperation(value = "Gets the requested saved search", notes = "Returns the  xdat saved search", response = XdatStoredSearchI.class)
    ...
    @ApiOperation(value = "Update an existing search saved", notes = "Updates the submitted search saved.", response = XdatStoredSearchI.class)
    ...
    public XdatStoredSearchI updateStoredSearch(@ApiParam("The ID of the search saved to be updated") @PathVariable final String searchId,
                                                ...
                                                @ApiParam("The event comment value ") @RequestParam(required = false) String eventComment) throws InitializationException {
    ...
    public void deleteSavedSearch(@ApiParam("The ID of the search saved to be deleted") @PathVariable final String searchId,
                                  ...
                                  @ApiParam("The event type value ") @RequestParam(required = false) String eventType,
                                  @ApiParam("The event  action value ") @RequestParam(required = false) String eventAction,
                                  @ApiParam("The event comment value ") @RequestParam(required = false) String eventComment) throws SQLException {
    ...
    public void deleteSavedSearchByProjectIdAndSearchId(@ApiParam(value = "The ID of the search saved.") @PathVariable final String searchId,
                                                        ...
                                                        @ApiParam("The event type value ") @RequestParam(required = false) String eventType,
                                                        @ApiParam("The event  action value ") @RequestParam(required = false) String eventAction,
                                                        @ApiParam("The event comment value ") @RequestParam(required = false) String eventComment) throws JustificationAbsent, ActionNameAbsent {

...
public class AutoHandlerScriptTriggerTemplateApi<T> extends AbstractXapiProjectRestController {
	...
	@ApiOperation(value = "Update the requested  handlers template", notes = "Returns the  handlers template with the specified ID", response = XnatProjectdata.class, responseContainer = "single")

...
public class User {
    ...
    private static final RowMapper<User> USER_ROW_MAPPER        = (resultSet, index) -> User.builder()
                                                                                            ...
                                                                                            .secured(true)
                                                                                            .lastModified(DateUtils.getDateForTimestamp(resultSet.getTimestamp("last_modified")))
                                                                                            .enabled(resultSet.getInt("enabled") == 1)
                                                                                            .verified(resultSet.getInt("verified") == 1)
                                                                                            .lastSuccessfulLogin(DateUtils.getDateForTimestamp(resultSet.getTimestamp("last_successful_login"))).build();

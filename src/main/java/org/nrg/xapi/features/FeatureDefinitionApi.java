...
@ResponseBody
@Slf4j
public class FeatureDefinitionApi<T> extends AbstractXapiProjectRestController {
	
	@Autowired
    public FeatureDefinitionApi(final UserManagementServiceI userManagementService, final RoleHolder roleHolder, final FeatureDefinitionService<T> featureDefinitionService) {
